...
const ChefInfo: FC<ChefInfoFormProps> = ({ nextStep }) => {
  const {
    handleSubmit,
    control,
    formState: { isValid },
  ...
  const watchFields = watch(["name", "shortIntro", "affiliation", "experience"]);
        ...
        <div className="relative">
          ...
          >
            <g filter="url(#filter0_d_62_3160)">
              <rect x="8" y="8" width="25" height="25" rx="12.5" fill="#DBE8B6" />
              <rect x="6.5" y="6.5" width="28" height="28" rx="14" stroke="white" strokeWidth="3" />
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
          ...
          <div className="relative flex flex-col items-start gap-[8px]">
            ...
            {isDropdownOpen && (
              <div className="flex flex-col w-[321px] border border-[#D1D6DB] rounded-[4px] bg-[#FFF] mt-[8px]">
                {["1년 이하", "1~3년", "3~5년", "5년 이상"].map((experience) => (
                  <div
                    key={experience}
                    ...
                    className={`flex items-center justify-between px-[16px] py-[8px] gap-[23px] text-[#707A87] text-[14px] font-pretendard leading-[22px] cursor-pointer ${
                      selectedExperience === experience ? "bg-[#EEF3E2] text-[#333E4E]" : ""
                    }`}
                  >
